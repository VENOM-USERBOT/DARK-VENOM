...
#RUN git clone -b master https://github.com/VENOM-USERBOT/DARK-VENOM /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/VENOM-USERBOT/DARK-VENOM/master/venom.py
RUN wget https://raw.githubusercontent.com/VENOM-USERBOT/DARK-VENOM/master/requirements.txt
